...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject:'FashionSocial',
        html:`
        <div style=" max-width: 600px; margin:auto; border: 8px solid rgb(100, 100, 100); padding: 50px 20px; font-size: 120%;">
    
            <h2 style="text-align: center; color: darkslategray;">Welcome to Fashion Social !</h2>
    
            <p>Congratulations! You have completed the account to join the Fashion Social community.
